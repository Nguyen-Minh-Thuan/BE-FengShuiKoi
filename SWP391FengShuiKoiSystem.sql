...
VALUES 
    (1, 3, 1, N'Beautiful Japanese Koi for Sale', N'High-quality koi fish with vibrant colors and unique patterns, perfect for any pond. Available for a limited time!', 5, 1, CAST(N'2024-09-20T00:00:00.000' AS DateTime), CAST(N'2024-09-24T00:00:00.000' AS DateTime), N'None', 0, GETDATE()),
    (1, 4, 1, N'Premium Imported Koi Fish Collection', N'Discover our premium selection of koi fish, directly imported from Japan. Enhance your pond with these stunning beauties!', 5, 2, CAST(N'2024-09-20T00:00:00.000' AS DateTime), CAST(N'2024-12-25T00:00:00.000' AS DateTime), N'None', 1, GETDATE()),
    (1, 4, 2, N'Limited Edition Koi Fish Now Available', N'Get your hands on rare koi fish breeds with exclusive patterns. Perfect for collectors and enthusiasts!', 5, 3, CAST(N'2024-09-20T00:00:00.000' AS DateTime), CAST(N'2024-09-25T00:00:00.000' AS DateTime), N'None', 1, GETDATE()),
    (1, 5, 2, N'Koi Fish for Your Dream Pond', N'Create a mesmerizing pond with our colorful koi fish. Available in various sizes and colors to suit your space.', 5, 4, CAST(N'2024-09-20T00:00:00.000' AS DateTime), CAST(N'2024-12-24T00:00:00.000' AS DateTime), N'None', 1, GETDATE()),
	(1, 3, 1, N'Exclusive Japanese Koi for Sale', N'High-quality koi fish with distinct patterns and vibrant colors. Limited stock, so act fast!', 5, 1, CAST(N'2024-09-20T00:00:00.000' AS DateTime), CAST(N'2024-10-24T00:00:00.000' AS DateTime), N'None', 0, GETDATE()),
    (1, 4, 1, N'Stunning Koi Fish Collection Available', N'Hand-picked, premium koi fish to make your pond stand out. Imported directly from Japan!', 5, 2, CAST(N'2024-09-20T00:00:00.000' AS DateTime), CAST(N'2024-12-25T00:00:00.000' AS DateTime), N'None', 1, GETDATE()),
    (1, 4, 2, N'Rare Koi Fish Breeds for Sale', N'Enhance your collection with our rare koi fish varieties. Perfect for any koi enthusiast!', 5, 3, CAST(N'2024-09-20T00:00:00.000' AS DateTime), CAST(N'2024-10-30T00:00:00.000' AS DateTime), N'None', 1, GETDATE()),
    (1, 5, 2, N'Colorful Koi Fish for Your Pond', N'Add life to your pond with vibrant, hand-selected koi fish. Available in various colors and patterns!', 5, 4, CAST(N'2024-09-20T00:00:00.000' AS DateTime), CAST(N'2024-12-24T00:00:00.000' AS DateTime), N'None', 1, GETDATE()),
    (1, 3, 1, N'Hand-Picked Koi Fish for Sale', N'Carefully selected koi fish with unique markings, ideal for a beautiful pond display. Limited stock available!', 5, 1, CAST(N'2024-09-20T00:00:00.000' AS DateTime), CAST(N'2024-10-15T00:00:00.000' AS DateTime), N'None', 0, GETDATE()),
    (1, 4, 1, N'Japanese Koi Fish – Add Color to Your Pond', N'Brighten up your pond with our colorful Japanese koi. Available now for a limited time!', 5, 2, CAST(N'2024-09-20T00:00:00.000' AS DateTime), CAST(N'2024-11-30T00:00:00.000' AS DateTime), N'None', 1, GETDATE()),
    (1, 4, 2, N'High-Quality Koi Fish Collection', N'Featuring koi with vibrant colors and great health. Perfect addition for koi fish lovers.', 5, 3, CAST(N'2024-09-20T00:00:00.000' AS DateTime), CAST(N'2024-10-15T00:00:00.000' AS DateTime), N'None', 1, GETDATE()),
    (1, 5, 2, N'Rare and Beautiful Koi Fish', N'Select koi fish breeds with one-of-a-kind patterns. Excellent choice for collectors and pond owners.', 5, 4, CAST(N'2024-09-20T00:00:00.000' AS DateTime), CAST(N'2024-11-24T00:00:00.000' AS DateTime), N'None', 1, GETDATE()),
    (1, 3, 1, N'Imported Japanese Koi Fish Sale', N'Imported koi with brilliant colors and exceptional health. Great addition for a stunning pond!', 5, 1, CAST(N'2024-09-20T00:00:00.000' AS DateTime), CAST(N'2024-10-24T00:00:00.000' AS DateTime), N'None', 0, GETDATE()),
    (1, 4, 1, N'Vibrant Koi Fish for Sale', N'Koi fish with captivating patterns and colors. Perfect for creating a serene pond atmosphere.', 5, 2, CAST(N'2024-09-20T00:00:00.000' AS DateTime), CAST(N'2024-12-25T00:00:00.000' AS DateTime), N'None', 1, GETDATE()),
    (1, 4, 2, N'Exclusive Koi Fish from Japan', N'High-quality, imported koi fish with vibrant colors to transform your pond.', 5, 3, CAST(N'2024-09-20T00:00:00.000' AS DateTime), CAST(N'2024-10-30T00:00:00.000' AS DateTime), N'None', 1, GETDATE()),
    (1, 5, 2, N'Koi Fish for a Beautiful Pond', N'Enhance your pond with colorful, healthy koi fish. Various patterns available to suit your style!', 5, 4, CAST(N'2024-09-20T00:00:00.000' AS DateTime), CAST(N'2024-12-24T00:00:00.000' AS DateTime), N'None', 1, GETDATE());
